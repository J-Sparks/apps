...
ui <- dashboardPage( skin = "green",
                     ...
                     sidebarMenu(id = "Menu...",                  
                        ...
                        menuItem( text= "Migration FTIC", startExpanded = T,icon = icon("fa-solid fa-map"),
                            menuSubItem(text = "Entry or Exit Flow Graph",  tabName = "flowchart")

                        ),# menuitem
                        menuItem( text = "Characteristics FTIC", startExpanded = T, icon = icon("fa-solid fa-address-card"),
